...
void afficherTitre() {
    ...
    printf("%s .----------------.  .-----------------. .----------------.  .----------------.  .----------------.  .----------------.  .----------------. \n", padding_str);
    printf("%s| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |\n", padding_str);
    printf("%s| |     _____    | || | ____  _____  | || | ____   ____  | || |      __      | || |  ________    | || |  _________   | || |  _______     | |\n", padding_str);
    printf("%s| |    |_   _|   | || ||_   \\|_   _| | || ||_  _| |_  _| | || |     /  \\     | || | |_   ___ `.  | || | |_   ___  |  | || | |_   __ \\    | |\n", padding_str);
    printf("%s| |      | |     | || |  |   \\ | |   | || |  \\ \\   / /   | || |    / /\\ \\    | || |   | |   `. \\ | || |   | |_  \\_|  | || |   | |__) |   | |\n", padding_str);
    printf("%s| |      | |     | || |  | |\\ \\| |   | || |   \\ \\ / /    | || |   / ____ \\   | || |   | |    | | | || |   |  _|  _   | || |   |  __ /    | |\n", padding_str);
    printf("%s| |     _| |_    | || | _| |_\\   |_  | || |    \\ ' /     | || | _/ /    \\ \\_ | || |  _| |___.' / | || |  _| |___/ |  | || |  _| |  \\ \\_  | |\n", padding_str);
    printf("%s| |    |_____|   | || ||_____|\\____| | || |     \\_/      | || ||____|  |____|| || | |________.'  | || | |_________|  | || | |____| |___| | |\n", padding_str);
    printf("%s| |              | || |              | || |              | || |              | || |              | || |              | || |              | |\n", padding_str);
    printf("%s| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |\n", padding_str);
    printf("%s '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' \n", padding_str);
